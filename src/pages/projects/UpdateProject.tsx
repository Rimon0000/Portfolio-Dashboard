...
import { useGetSingleProjectQuery, useUpdateProjectMutation } from "@/redux/features/projects/projectsApi"
...
const UpdateProject = () =>{
  ...
  const handleUpdate = (e: any) =>{
    ...
    return (
      ...
      <h1 className="text-3xl font-semibold mb-5"> Update Project</h1>
      <div className="w-full flex justify-center items-center">
          <form onSubmit={handleUpdate} className="bg-slate-100 shadow-md rounded px-8 pt-6 w-full lg:w-4/5"> 
